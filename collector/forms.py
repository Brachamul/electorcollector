...
class InscritForm(forms.ModelForm):
	class Meta:
		model = Inscrit
		fields = ['email', 'prenom', 'nom', 'adresse_postale', 'numero_de_telephone', 'numero_adherent', 'date_de_naissance', 'photo', 'cni', 'declaration', 'bio', 'departement', 'compte_twitter', 'compte_facebook']
		# , 'document'
		help_texts = {
